...
<!-- VITRO:::::::::::::::::::::: Fields from original schema.xml -->
  ...
  <!-- VITRO:::::::::::::::::::::: Fields from original schema.xml -->
   ...
   -->
   <!--  I am not sure whether or not to keep this? Commenting out for now since not doing anything with SolrCell currently? -->
   ...
   <dynamicField name="*_label_sort"  type="string"  indexed="true"  stored="true" />
   <dynamicField name="*_label_display"  type="string"  indexed="true"  stored="true" />
...
<!-- This is deprecated so please take this out next time.  Note: MM is set to 100% under the select request handler in solrconfig.xml-->
  ...
  <types>
   ...
   <fieldType name="boolean" class="solr.BoolField" sortMissingLast="true" omitNorms="true"/>
    ...
    -->
    <fieldType name="tint" class="solr.TrieIntField" precisionStep="8" positionIncrementGap="0" omitNorms="true" sortMissingLast="true"/>
    ...
    <!-- A text field type for sorting -->
    <fieldType name="sort" class="solr.TextField" omitNorms="true" sortMissingLast="true">
      <analyzer>
...
<!-- From new example which I am commenting out for now -->
    <!-- lowercases the entire field value, keeping it as a single token.  -->
    <!-- fieldType name="lowercase" class="solr.TextField" positionIncrementGap="100">
      <analyzer>
        <tokenizer class="solr.KeywordTokenizerFactory"/>
...
<!-- Next 2 are from the original schema.xml -->
  ...
  <!--
    ...
    -->
    <!--  Note the path changed from the original Vitro version -->
